...
export default function App() {
  ...
  return (
    <div style={{ padding: '30px', fontFamily: 'Arial, sans-serif', backgroundColor: '#fdfefe', minHeight: '100vh' }}>
      <div style={{ marginBottom: '20px', borderBottom: '2px solid #eaeded', paddingBottom: '15px' }}>
        <h2>Smart Inventory & Supply Chain System</h2>
        <p style={{ color: '#7f8c8d' }}>Industrial Project Submission 2 - Stock Monitoring & Reorder Optimization</p>
      </div>
      ...
      {lowStockItems.length > 0 && (
        <div style={{ backgroundColor: '#f8d7da', color: '#721c24', padding: '15px', borderRadius: '6px', marginBottom: '25px', border: '1px solid #f5c6cb' }}>
          <strong>⚠️ Automated System Alert: Low Stock Detected!</strong>
      ...
      <div style={{ display: 'flex', gap: '20px', marginBottom: '30px' }}>
        ...
        <div style={{ flex: 1, backgroundColor: '#ffeaa7', padding: '15px', borderRadius: '6px' }}>
          <h4 style={{ margin: '0 0 5px 0', color: '#d63031' }}>Reorder Alerts Issued</h4>
      ...
      <div style={{ display: 'flex', gap: '20px' }}>
        ...
        <div style={{ flex: 1, backgroundColor: '#fff', padding: '20px', borderRadius: '8px', border: '1px solid #eaeded', height: 'fit-content' }}>
          ...
          <form onSubmit={handleAddItem} style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '15px' }}>
            ...
            <button type="submit" style={{ padding: '10px', backgroundColor: '#2f3542', color: '#fff', border: 'none', fontWeight: 'bold', cursor: 'pointer' }}>Register Item</button>
          </form>
        </div>
      </div>
    </div>
